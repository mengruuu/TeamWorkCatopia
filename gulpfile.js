...
function browser(done) {
  ...
  watch(["src/frontend/*.html", "src/frontend/**/*.html"], html).on(
    "change",
    reload
  );
  //   watch(['src/fronted/layout/*.html'] , html).on('change' , reload);
  watch(["src/backend/*.html", "src/backend/**/*.html"], Bhtml).on(
    "change",
    reload
  );
  watch(["src/sass/page/*.scss", "src/sass/layout/*.scss"], sassstyle).on(
    "change",
    reload
  );
  watch(["src/sass/backend/*.scss", "src/sass/layout/*.scss"], Bsassstyle).on(
    "change",
    reload
  );
